// This File Contains a Random Test Generator for the Great Hall
...
// Compare State After to State Before (Tests)
	...
	// Test - Player's Actions Increase By 1
		if (stateAfter.numActions == (stateBefore.numActions + 1)) {
			printf("TEST - Player's Action Count Has Increased By 1 - PASSED\n");
		}
		else {
			printf("TEST - Player's Action Count Has Increased By 1 - FAILED\n");
			errorFlag = 1;
		}
